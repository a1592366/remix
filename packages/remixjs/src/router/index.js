...
import { miniCreateClass, getWindow } from '../react/util';
...
const supportPushState = !!window.history && window.history.pushState;
const supportHashChange = !!('onhashchange' in window )
...
let { unstable_deferredUpdates } = React
...
const LocationProvider = miniCreateClass(
