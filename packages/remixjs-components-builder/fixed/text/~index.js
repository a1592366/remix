...
Component({
  ...
  methods: {
    ...
    onTouchStart (e) { transports.view.dispatch('onTouchStart', e.target.uuid, this.data.parent, e, this) },
    ...
    onLongTap (e) { transports.view.dispatch('onLongTap', e.target.id, this.data.parent, e, this) },
