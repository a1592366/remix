...
/******/ 	var installedChunks = {
/******/ 		"remix-ui/remix-scroll-view/index": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./.~remix/remix-ui/remix-scroll-view/~index.js","runtime/vendor/manifest"]);
...
/***/ "./.~remix/remix-ui/remix-scroll-view/~index.js":
/*!******************************************************!*\
  !*** ./.~remix/remix-ui/remix-scroll-view/~index.js ***!
  \******************************************************/
...
Component({
  ...
  methods: {
    onScrollToUpper: function onScrollToUpper(e) {
      _project.transports.view.dispatch('onScrollToUpper', this.data.uuid, e);
    },
    onScrollToLower: function onScrollToLower(e) {
      _project.transports.view.dispatch('onScrollToLower', this.data.uuid, e);
    },
    onScroll: function onScroll(e) {
      _project.transports.view.dispatch('onScroll', this.data.uuid, e);
    },
