/*** MARK_1572195887871 WeChat globalWindow ***/ var window = Object.__globalWindow__ || (Object.__globalWindow__ = {}); /*** WeChat globalWindow ***/ /******/ (function(modules) { // webpackBootstrap
...
/******/ 	deferredModules.push(["./.~remix/remix-ui/remix-map/~index.js","runtime/vendor/manifest"]);
...
/***/ "./.~remix/remix-ui/remix-map/~index.js":
/*!**********************************************!*\
  !*** ./.~remix/remix-ui/remix-map/~index.js ***!
  \**********************************************/
...
Component({
  ...
  methods: {
    onMarkerTap: function onMarkerTap(e) {
      _project.transports.view.dispatch('onMarkerTap', this.data.uuid, e);
    },
    onLabelTap: function onLabelTap(e) {
      _project.transports.view.dispatch('onLabelTap', this.data.uuid, e);
    },
    onControlTap: function onControlTap(e) {
      _project.transports.view.dispatch('onControlTap', this.data.uuid, e);
    },
    onCalloutTap: function onCalloutTap(e) {
      _project.transports.view.dispatch('onCalloutTap', this.data.uuid, e);
    },
    onUpdated: function onUpdated(e) {
      _project.transports.view.dispatch('onUpdated', this.data.uuid, e);
    },
    onRegionChange: function onRegionChange(e) {
      _project.transports.view.dispatch('onRegionChange', this.data.uuid, e);
    },
    onPoiTap: function onPoiTap(e) {
      _project.transports.view.dispatch('onPoiTap', this.data.uuid, e);
    },
